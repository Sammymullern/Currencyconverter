...
"LAK : Lao Kip,Laos Kip",
 ...
 "XAF : Central African CFA Franc BEAC,Communaut&#233; Financi&#232;reAfricaine (BEAC) CFA Franc BEAC,Cameroon,Central African Republic,Chad,Congo/Brazzaville,Equatorial Guinea,Gabon",
...
def function1():
 query = input(
 "Please specify the amount of currency to convert(with space in between). \n"
